            ...
            <div className={cv('wrapper-Login-center')}>
                ...
                <div className={cv('wrapperForm')}>
                    <form>
                        ...
                        <input onChange={(e) => getValue(e, 'password')} class="form-control" type="text" placeholder="Mật khẩu...." aria-label="default input example" />
                        <input onChange={(e) => getValue(e, 'confirmPassword')} class="form-control" type="text" placeholder="Nhập lại mật khẩu...." aria-label="default input example" />
                        <input onChange={(e) => getValue(e, 'address')} class="form-control" type="text" placeholder="Địa chỉ...." aria-label="default input example" />
                        <input onChange={(e) => getValue(e, 'phonenumber')} class="form-control" type="text" placeholder="Sdt..." aria-label="default input example" />
